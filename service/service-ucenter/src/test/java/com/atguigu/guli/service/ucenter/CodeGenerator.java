...
public class CodeGenerator {
    ...
    public void genCode() {
        ...
        //定义生成的实体类中日期类型
        GlobalConfig globalConfig = gc.setDateType(DateType.ONLY_DATE);
        gc.setSwagger2(true);//开启Swagger2模式
        mpg.setGlobalConfig(gc);
        // 3、数据源配置
        DataSourceConfig dsc = new DataSourceConfig();
        dsc.setUrl("jdbc:mysql://localhost:3306/" + prefix + "guli_" + moduleName + "?characterEncoding=utf-8&useSSL=false");
